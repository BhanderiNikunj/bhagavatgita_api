...
List<AllModel> allModelFromJson(String str) => List<AllModel>.from(json.decode(str).map((x) => AllModel.fromJson(x)));

String allModelToJson(List<AllModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
